const baseStyles = `
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .badge { display: inline-block; background: #F5F0E8; color: #4B3C2A; font-size: 13px; font-weight: 600; padding: 6px 14px; border-radius: 20px; margin: 16px 0 20px; border: 1px solid #E8E0D0; }
...
<body>
  <div class="wrapper">
    ...
    <div class="card">
      ...
      <h1>Your pod starts in 1 hour</h1>
      <p>Don't keep your orcas waiting — <span class="highlight">{{eventName}}</span> is almost time.</p>
      <span class="badge">📍 Starting soon</span>
      <hr class="divider" />
      <p>Make sure you're ready to go. Head to the app to view details, check who's joining, and get directions.</p>
      <a href="#" class="cta-btn">Open the app</a>
    </div>
    <div class="footer">
