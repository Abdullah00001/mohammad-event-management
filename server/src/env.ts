...
export const env: TEnv = {
  ...
  REVENUECAT_API_KEY: getEnv('REVENUECAT_API_KEY'),
  REVENUECAT_WEBHOOK_SECRET: getEnv('REVENUECAT_WEBHOOK_SECRET'),
  DIDIT_API_URL: getEnv('DIDIT_API_URL'),
  DIDIT_API_KEY: getEnv('DIDIT_API_KEY'),
  DIDIT_WORKFLOW_ID: getEnv('DIDIT_WORKFLOW_ID'),
  DIDIT_WEBHOOK_SECRET: getEnv('DIDIT_WEBHOOK_SECRET'),
};
